...
int main(void)
{
  ...
  while (1)
  {
	  GPIO_PinState btnState = HAL_GPIO_ReadPin(CLR_BUTTON_GPIO_Port, CLR_BUTTON_Pin);
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin : CLR_BUTTON_Pin */
  GPIO_InitStruct.Pin = CLR_BUTTON_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(CLR_BUTTON_GPIO_Port, &GPIO_InitStruct);
